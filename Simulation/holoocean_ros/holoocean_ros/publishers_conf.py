...
class ImagePublisher:
    ...
    def publish_images(self, state, sim_time):
        ...
        if "Cam0DepthImg" in state:
            ...
            # Convert to meters
            depth_meters = np.clip(valid_depth, 0.1, 1000.0) / 100.0
            depth_meters_mask = depth_meters < 9.9
            ...
            # Optional: Combine with depth-based confidence
            # confidence *= (1.0 / (depth_meters**2))  # Uncomment to merge with inverse-square
