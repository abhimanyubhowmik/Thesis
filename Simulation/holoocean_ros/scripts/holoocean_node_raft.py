...
from holoocean_ros.publisher_raft import ImagePublisher, SensorPublisher, PathPublisher
...
class HoloOceanNode:
    def __init__(self):
        ...
        left_intrinsics_path = rospy.get_param('~left_camera_intrinsics_file', 
                                        'left_holoocean.yaml')
        
        right_intrinsics_path = rospy.get_param('~right_camera_intrinsics_file', 
                                        'right_holoocean.yaml')
        ...
        self.env.weather.set_fog_density(rospy.get_param('~fog_density', 2.0))
        self.env.set_render_quality(rospy.get_param('~render_quality', 3))

        # Initialize publishers
        self.image_publisher = ImagePublisher(intrinsics_path,left_intrinsics_path,right_intrinsics_path)
        ...
        rospy.loginfo("HoloOcean Integrated Node Initialized")
    ...
    def control_loop(self, event):
        ...
        # Get current pose for path updates
